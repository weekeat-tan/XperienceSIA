...
const MovieRecommendationsScreen = (props) => {
    ...
    movieList.push({
        ...
        movieTitle: "A Star is Born (2018)",
        ratings: '7.7',
        key: 2
    })
    ...
    movieList.push({
        uri: "https://m.media-amazon.com/images/M/MV5BMjY5MTQ4MDgtZDc4ZC00ODA3LWJlYjAtMTc3MzJhNDIxMDBlXkEyXkFqcGdeQXVyNDAyMjYyMzQ@._V1_UY268_CR9,0,182,268_AL_.jpg",
        movieTitle: "Sharato Lagu",
        ratings: '7.7',
        key: 5
    })
    ...
    movieList.push({
        uri: "https://m.media-amazon.com/images/M/MV5BYTU1MzMxYTAtNDg2Yy00ODhjLWEzZDctMTU3YmI2NDg5YjE5XkEyXkFqcGdeQXVyMjQ3NzUxOTM@._V1_UY268_CR3,0,182,268_AL_.jpg",
        movieTitle: "Champions",
        ratings: '7.2',
        key: 10
    })
